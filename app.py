...
# Web App Title
st.image("/Users/fwworner/Desktop/Excel File Merger Web App/HABLABS-Logo-2022-2.png")
...
with st.sidebar.header('1. Upload your ZIP file'):
    uploaded_file = st.sidebar.file_uploader("ZIP file containing Excel Spreadsheets", type=["zip"])
    st.sidebar.markdown("""
